...
namespace CSharpAI
{
    ...
    {
        public double MaxPackDiameterOuterThreshold = 500;
        public double MaxPackDiameterInnerThreshold = 300;
        public double movetothreshold = 20;
        public int MaxPackToConsider = 5;

        public double AttackDistance = 50;
        ...
        {
           // foreach( UnitInfo unitinfo in closestunits )
        //    {
         //       if( unitinfo.unitdef.
         //   }
        }
